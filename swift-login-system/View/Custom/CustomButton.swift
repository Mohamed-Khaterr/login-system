...
class CustomButton: UIButton {
    ...
    init(title: String, hasBackground: Bool = false, iconName: String? = nil, fontSize: FontSize){
        ...
        setupTextField(title: title, hasBackground: hasBackground, iconName: iconName, fontSize: fontSize)
    }
    ...
    private func setupTextField(title: String, hasBackground: Bool = false, iconName: String? = nil, fontSize: FontSize){
